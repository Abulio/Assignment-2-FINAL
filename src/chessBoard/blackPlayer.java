...
public class blackPlayer
{
    ...
    ImageIcon pawn = new ImageIcon("bPawn.png");//referencing the images in the folder
    ImageIcon rook = new ImageIcon("bRook.png");
    ImageIcon knight = new ImageIcon("bHorse.png");
    ...
    {//function that returns the possible moves back to board
        checkState=check();
        if(checkState==false)
        {
    ...
    {
        checkState=false;
        for (int i=1; i<=64; i++)//traverse the whole board and check every possible white player move
        {
            if(Board.getComponentByName(String.valueOf(i)).getClientProperty("player")=="white")
            {
                ...
                if (i<57 && i>48)
                {
                    if (Board.getComponentByName(String.valueOf(i-16)).getClientProperty("player").equals("black"))
                    {
                        pawnStartMove=false;
                    }
                }
                if ((i-8)>0)
                {
                    if (Board.getComponentByName(String.valueOf(i - 8)).getClientProperty("player").equals("black")) {
                        pawnMove = false;
                    }
                }
                Icon icon=Board.getComponentByName(String.valueOf(i)).getIcon();
                validMoves=Board.white.allMoves(icon, String.valueOf(i), pawnMove, pawnStartMove);//reference all the possible moves the white player can do
                for (int x = 0; x < validMoves[0].size(); x++)//traverse the provided list to see if any of the moves can result in the capture of the Black king
                {
                    if(Board.getComponentByName((String) validMoves[0].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[0].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[0].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
                ...
                {
                    if(Board.getComponentByName((String) validMoves[1].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[1].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[1].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
                ...
                {
                    if(Board.getComponentByName((String) validMoves[2].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[2].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[2].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
                ...
                {
                    if(Board.getComponentByName((String) validMoves[3].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[3].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[3].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
                ...
                {
                    if(Board.getComponentByName((String) validMoves[4].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[4].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[4].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
                ...
                {
                    if(Board.getComponentByName((String) validMoves[5].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[5].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[5].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
                ...
                {
                    if(Board.getComponentByName((String) validMoves[6].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[6].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[6].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
                ...
                {
                    if(Board.getComponentByName((String) validMoves[7].get(x)).getClientProperty("player").equals("white"))
                    {
                        break;
                    }
                    else if(Board.getComponentByName((String) validMoves[7].get(x)).getIcon()!=king && Board.getComponentByName((String) validMoves[7].get(x)).getClientProperty("player").equals("black"))
                    {
                        break;
                    }
    ...
    public ArrayList[] allMoves(Icon icon, String name, Boolean pawnMove, Boolean pawnStartMove) {//this function is referenced by white player to see if the black player can make a move putting them in check. It is not used in this class
        ...
        if (icon==pawn)//determine what class of piece is on the button
        {
            ...
            {
                if (Integer.parseInt(name) < 17 && Integer.parseInt(name) > 8)
                {
                    moveListS.add(String.valueOf(Integer.parseInt(name) + 8));
                    moveListS.add(String.valueOf(Integer.parseInt(name) + 16));
                }
            }
            if (pawnMove==true && Integer.parseInt(name) + 8<=64)
            {
                moveListS.add(String.valueOf(Integer.parseInt(name) + 8));
            }
            ...
            {
                if (Integer.parseInt(name)+7<=64)
                {
                    if(Board.getComponentByName(String.valueOf(Integer.parseInt(name)+7)).getClientProperty("player")=="white")
                    {
                        moveListSW.add(String.valueOf(Integer.parseInt(name) + 7));
                    }
                }
            }
            else if ((Integer.parseInt(name)-1)%8==0)
            {
                if (Integer.parseInt(name)+9<=64)
                {
                    if(Board.getComponentByName(String.valueOf(Integer.parseInt(name)+9)).getClientProperty("player")=="white")
                    {
                        moveListSE.add(String.valueOf(Integer.parseInt(name) + 9));
                    }
                }
            }
            else
        ...
        ArrayList [] validMoves = {moveListN, moveListNE, moveListE, moveListSE, moveListS, moveListSW, moveListW, moveListNW};//add all the arrayLists to an ArrayList[]
        return validMoves;
    }

    public ArrayList[] checkMoves(Icon icon, String name, Boolean pawnMove, Boolean pawnStartMove) {//very similar to the allMoves Function, this one is used in this class to get all the moves the black player can do without putting themselves into check
        ...
        if (icon==pawn)//determine what class of piece is on the button
        {
            if (Integer.parseInt(name) <= 64 && Integer.parseInt(name) > 56)
            {
            ...
            if (pawnMove==true && pawnStartMove==true)
            {
                if (Integer.parseInt(name) < 17 && Integer.parseInt(name) > 8)
                {
                    ...
                    Board.getComponentByName(String.valueOf(Integer.parseInt(name)+8)).putClientProperty("player","black");
                    checkState=check();
                    if (checkState==false)
                    {
                    ...
                    Board.getComponentByName(String.valueOf(Integer.parseInt(name)+16)).putClientProperty("player","black");
                    checkState=check();
                    if(checkState==false)
                    {
            ...
            if (Integer.parseInt(name)%8==0)
            {
                if (Integer.parseInt(name)+7<=64)
                {
                    if(Board.getComponentByName(String.valueOf(Integer.parseInt(name)+7)).getClientProperty("player")=="white")
                    {
                        ...
                        Board.getComponentByName(String.valueOf(Integer.parseInt(name)+7)).putClientProperty("player","black");
                        checkState=check();
                        if (checkState==false)
                        {
            ...
            else if ((Integer.parseInt(name)-1)%8==0)
            {
                if (Integer.parseInt(name)+9<=64)
                {
                    if(Board.getComponentByName(String.valueOf(Integer.parseInt(name)+9)).getClientProperty("player")=="white")
                    {
                        ...
                        Board.getComponentByName(String.valueOf(Integer.parseInt(name)+9)).putClientProperty("player","black");
                        checkState=check();
                        if (checkState==false)
                        {
        ...
        else if (icon==rook)
        {
            for (int i = Integer.parseInt(name)+8;i<=64;)
            {
                ...
                Board.getComponentByName(String.valueOf(i)).putClientProperty("player","black");
                checkState=check();
                if (checkState==false)
                {
                    moveListS.add(String.valueOf(i));
            ...
            if (Integer.parseInt(name) % 8 == 0) {
                if (Integer.parseInt(name) - 10 > 0) {
                    ...
                    Board.getComponentByName(String.valueOf(Integer.parseInt(name) - 10)).putClientProperty("player","black");
                    checkState=check();
                    if (checkState==false)
                    {
                ...
                if (Integer.parseInt(name) - 17 > 0) {
                    ...
                    Board.getComponentByName(String.valueOf(Integer.parseInt(name) -17)).putClientProperty("player","black");
                    checkState=check();
                    if (checkState==false)
                    {
                ...
                if (Integer.parseInt(name) + 6 <= 64) {
                    ...
                    Board.getComponentByName(String.valueOf(Integer.parseInt(name) +6)).putClientProperty("player","black");
                    checkState=check();
                    if (checkState==false)
                    {
                ...
                if (Integer.parseInt(name) + 15 <=64) {
                    ...
                    Board.getComponentByName(String.valueOf(Integer.parseInt(name) +15)).putClientProperty("player","black");
                    checkState=check();
                    if (checkState==false)
                    {
        ...
        else if (icon==king)
        {
            ...
            if (i-8>0)
            {
                ...
                Board.getComponentByName(String.valueOf(i-8)).putClientProperty("player","black");
            ...
            if (i%8==0)
            {
                ...
                Board.getComponentByName(String.valueOf(i-1)).putClientProperty("player","black");
                ...
                if (i-9>0)
                {
                    ...
                    Board.getComponentByName(String.valueOf(i-9)).putClientProperty("player","black");
                ...
                if (i+7<=64)
                {
                    ...
                    Board.getComponentByName(String.valueOf(i+7)).putClientProperty("player","black");
        ...
        }//the above code adds possible moves to the list. The moves are checked if they would cause a check from the opposing side, preventing the black player from putting himself into check and adds and discards moves accordingly
        Board.getComponentByName(name).putClientProperty("player","black");
